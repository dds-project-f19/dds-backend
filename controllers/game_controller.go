...
func (a *GameState) TransferInventory(c *gin.Context) {

}

func (a *GameState) UpdateUserLayout(c *gin.Context) {

}

func (a *GameState) GetAvailableInventory(c *gin.Context) {

}

func (a *GameState) UpdateInventory(c *gin.Context) {
